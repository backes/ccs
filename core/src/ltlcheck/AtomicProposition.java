...
public class AtomicProposition
{
	...
	{
		String ret = "";
		if(type == PropositionType.Can) ret += "can(";
		else if(type == PropositionType.Did) ret += "did(";
		ret += atom;
		if(type != PropositionType.Unknown) ret += ")";
		return ret;
	}
	...
	public boolean equals(Object obj)
	{
		...
		if (atom == null)
		{
			if (other.atom != null) return false;
		}
		else if (!atom.equals(other.atom)) return false;
		if (type == null)
		{
