            ...
            if ((ch = format[n++]) == '%') {
                if ((n = cvt.parse(format, n)) < flen) {
                    ...
                    case 'p':
                        ...
                        if (args[argn] instanceof java.awt.geom.Point2D)
                            cvt.buildPoint(prtbuf,
                                ((java.awt.geom.Point2D) args[argn++]), false);
                    ...
                    case 'P':
                        ...
                        if (args[argn] instanceof java.awt.geom.Point2D)
                            cvt.buildPoint(prtbuf,
                                ((java.awt.geom.Point2D) args[argn++]), true);
                        else if (args[argn] instanceof java.awt.geom.Dimension2D)
                            cvt.buildSize(prtbuf,
                                ((java.awt.geom.Dimension2D) args[argn++]),
                                true);
...

{
    ...
    private final StringBuffer scratch;
    ...
    final StringBuffer buildBox(StringBuffer buf,
        ...
        final double[] arg = { 0, 0, 0, 0 };
        final double[] exp = { 0, 0, 0, 0 };
        final double[] val = { 0, 0, 0, 0 };
        final double[] ival = { 0, 0, 0, 0 };
        final int[] iexp = { 0, 0, 0, 0 };
        StringBuffer retbuf = null;
        int orig_precision;
        trim = true;
    ...
    final StringBuffer buildHex(StringBuffer buf, int arg, boolean upper) {
        ...
        str =
                (upper) ? Integer.toHexString(arg).toUpperCase() : Integer
                    .toHexString(arg);
    ...
    private String doubleToString(double val, String exp) {
        ...
        if (zeropad && !rightpad) {
            final String str = scratch.toString();
            scratch.setLength(0);
