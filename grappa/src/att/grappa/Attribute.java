...
public final class Attribute extends java.util.Observable implements
    ...
    public static AttributeHandler setAttributeHandler(
        ...
        final AttributeHandler oldHandler = specialHandler;
    ...
    public final Object getValue() {
        if (value == null && stringValue != null) {
            value =
                    convertStringValue(elementType, name, stringValue,
                        attributeType);
        }
        return value;
    }
    ...
    public final Object setValue(Object attrValue) {
        ...
        if (attrValue != null) {
            if (isString) {
                changed = stringValue == null || !attrValue.equals(stringValue);
                if (changed) {
                ...
                if (changed) {
                    value =
                            copyValue(elementType, name, attrValue,
                                attributeType);
                    stringValue = null;
                }
            }
    ...
    public String convertValue(int type, String name, Object value, int attrtype) {
        ...
        case DIR_TYPE:
            if (value instanceof Integer) {
                stringValue =
                        GrappaSupport.xlateDir(((Integer) value).intValue());
            } else {
                throw new IllegalArgumentException("value of attribute \""
        ...
        case FONTSTYLE_TYPE:
            if (value instanceof Integer) {
                stringValue =
                        GrappaSupport.xlateFontStyle(((Integer) value)
                            .intValue());
            } else {
                throw new IllegalArgumentException("value of attribute \""
                        + name + "\" is not an instance of Integer");
        ...
        case HASHLIST_TYPE:
            if (value instanceof Hashtable) {
                ...
                final Enumeration<?> keys = ((Hashtable<?, ?>) value).keys();
                synchronized (strbuf) {
        ...
        default:
            if (Attribute.specialHandler != null) {
                stringValue =
                        Attribute.specialHandler.convertValue(type, name,
                            value, attrtype);
            } else {
    ...
    public Object convertStringValue(int type, String name, String stringValue,
        ...
        if (stringValue == null
                || (attrtype != STRING_TYPE && stringValue.trim().length() == 0)) {
            stringValue = null;
        } else {
            ...
            case FONTSTYLE_TYPE:
                value =
                        new Integer(GrappaSupport
                            .xlateFontStyleString(stringValue));
                break;
            case HASHLIST_TYPE:
                final String[] listvals = GrappaSupport.strsplit(stringValue);
                ...
                for (int i = 0; i < listvals.length; i++) {
                    ((Hashtable<String, String>) value).put(listvals[i],
                        listvals[i]);
                }
                break;
            case INTEGER_TYPE:
            ...
            case SHAPE_TYPE:
                if ((value = Grappa.keyToShape.get(stringValue)) == null) {
                    Attribute attr;
                    if ((attr =
                            Graph.getGlobalAttribute(GrappaConstants.NODE,
                                "shape")) == null
            ...
            default:
                if (Attribute.specialHandler != null) {
                    value =
                            Attribute.specialHandler.convertStringValue(type,
    ...
    public Object copyValue(int type, String name, Object value, int attrtype) {
        ...
        default:
            if (Attribute.specialHandler != null) {
                copy_value =
                        Attribute.specialHandler.copyValue(type, name, value,
                            attrtype);
            } else {
                throw new RuntimeException(Element.typeString(type, true)
                        + " attribute (" + name + ") needs a special handler");
