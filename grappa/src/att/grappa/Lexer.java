...
public class Lexer {
    ...
    private final Hashtable<String, Integer> keywords =
            new Hashtable<String, Integer>(32);
    private final Hashtable<Integer, Integer> char_symbols =
    ...
    /**
     * Swallow up an html-like string. Html-like strings begin with a '<' and
     * include all characters up to the first matching occurrence of a '>' The
     * routine returns a Symbol object suitable for return by the scanner.
     */
