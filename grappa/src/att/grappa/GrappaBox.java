...
public class GrappaBox extends java.awt.geom.Rectangle2D.Double {
     ...
     * coordinates derived from the specified String representation. When the
     * <I>dimensioned</I> parameter is true, then the String format should be: "<I>x-coord</I>,<I>y-coord</I>,<I>width</I>,<I>height</I>"
     * otherwise it should be: "<I>x1-coord</I>,<I>y1-coord</I>,<I>x2-coord</I>,<I>y2-coord</I>"
     *
     * @param coordString
     ...
     * format should be: "<I>x-coord</I>,<I>y-coord</I>,<I>width</I>,<I>height</I>""
     *
     * @param coordString
     *            String representing the coordinates to which to set the newly
     *            constructed <code>GrappaBox</code>
     ...
     *
     * @param format
     *            the format used to build the string (<TT>%b</TT> is the
     *            base directive for a GrappaBox).
