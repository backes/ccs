...
public class Edge extends Element {
    ...
    public Edge(Subgraph subg, Node tail, String tailPort, Node head,
        ...
        if (!directed && tail.getId() > head.getId()) {
            final Node tmpNode = tail;
            tail = head;
            head = tmpNode;
            final String tmpPort = tailPort;
            tailPort = headPort;
            headPort = tmpPort;
        }
        tailNode = tail;
    ...
    void setName() {
        ...
        while (true) {
            name =
                    Edge.defaultNamePrefix + getId() + "_"
    ...
    public static int attributeType(String attrname) {
        ...
        if (attrname != null) {
            ...
            } else if (hashCode == HEADLABEL_HASH
                    && attrname.equals(HEADLABEL_ATTR)) {
                convtype = STRING_TYPE;
            } else if (hashCode == HEADLP_HASH && attrname.equals(HEADLP_ATTR)) {
                convtype = POINT_TYPE;
            } else if (hashCode == TAILLABEL_HASH
                    && attrname.equals(TAILLABEL_ATTR)) {
                convtype = STRING_TYPE;
