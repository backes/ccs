...
public class Parser extends java_cup.runtime.lr_parser {
    ...
    protected static final short _production_table[][] =
            unpackFromStrings(new String[] { "\000\077\000\002\002\004\000\002\042\002\000\002\013"
    ...
    protected static final short[][] _action_table =
            unpackFromStrings(new String[] { "\000\121\000\020\002\ufffd\003\010\004\ufff8\012\007\013"
    ...
    protected static final short[][] _reduce_table =
            unpackFromStrings(new String[] { "\000\121\000\010\003\005\013\010\014\011\001\001\000"
    ...
    public java_cup.runtime.Symbol do_action(int act_num,
            java_cup.runtime.lr_parser parser, java.util.Stack<Symbol> stack, int top)
     ...
     * a supplied <code>Graph</code> object. The graph object is cleared
     * (reset) before new graph components are added to it by this parsing
     * operation.
     *
     * @param inputReader
     ...
     *            error output)
     * @param graph
     *            <code>Graph</code> object for storing parsed graph
     *            information (or null to create a new object)
     */
     ...
     * a <code>Reader</code> and the error stream is converted to a
     * <code>Writer</code>.
     *
     * @param inputStream
    ...
    public void report_error(String message, Object info)
        ...
        final String loc = getLexer().getLocation();
        if (errWriter != null) {
    ...
    public Symbol debug_parse(int debug) throws java.lang.Exception {
        ...
        for (_done_parsing = false; !_done_parsing;) {
            ...
            act =
                    get_action(stack.peek().parse_state,
                        cur_token.sym);
            ...
            /* if its less than zero, then it encodes a reduce action */
                ...
                act =
                        get_reduce(stack.peek().parse_state,
                            lhs_sym_num);
...
class CUP$Parser$actions {
    ...
    Vector<Attribute> attrs = new Vector<Attribute>(8, 4);
    Vector<Object[]> nodes = new Vector<Object[]>(8, 4);
    Vector<Object[]> edges = new Vector<Object[]>(8, 4);
    ...
    void attrStmt(int kind, String macroName) {
        ...
        for (int i = 0; i < attrs.size(); i++) {
            if ((attr = (attrs.elementAt(i))).getValue() == null) {
    ...
    void openGraph() {
        ...
        thisElemType = GrappaConstants.SUBGRAPH;
    ...
    String anonStr() {
        return GrappaConstants.ANONYMOUS_PREFIX + anon_id++;
    }
    ...
    void appendNode(String name, String port) {
        ...
        thisElemType = GrappaConstants.NODE;
    }
    ...
    void bufferEdges() {
        ...
        if (nodes.size() > 0) {
            ...
            parser.report_error(
                "EDGE_OP without clear antecedent nodelist or subgraph", null);
            return;
        }
    ...
    void edgeWrap() {
        ...
        for (int i = 1; i < edges.size(); i++) {
            ...
            if (((Boolean) (tailPair[1])).booleanValue()) { // true if node list
                ...
                final Subgraph subg = (Subgraph) (tailPair[0]);
                final Enumeration<?> enm = subg.elements(GrappaConstants.NODE);
                while (enm.hasMoreElements()) {
                    edgeRHS((Node) (enm.nextElement()), null, headPair, key,
                        name);
                }
            }
            tailPair = headPair;
    ...
    void edgeRHS(Node tail, String tailPort, Object[] headPair,
        ...
        final String key = (keyAttr == null) ? null : keyAttr.getStringValue();
        final String name = (nameAttr == null) ? null : nameAttr.getStringValue();
        if (((Boolean) (headPair[1])).booleanValue()) { // true if node list
            final Vector<?> list = (Vector<?>) (headPair[0]);
            Object[] nodePair = null;
            for (int j = 0; j < list.size(); j++) {
                nodePair = (Object[]) (list.elementAt(j));
                thisEdge =
                        new Edge(thisGraph, tail, tailPort,
                                (Node) (nodePair[0]), (String) (nodePair[1]),
                                key, name);
                parser.debug_message(1, "Creating edge in subgraph ("
                        + thisGraph.getName() + ")...");
                parser.debug_message(1, "thisEdge(" + thisEdge.getName() + ")");
                thisElemType = GrappaConstants.EDGE;
                applyAttrs(thisEdge, keyAttr, nameAttr);
            }
        } else {
            final Subgraph subg = (Subgraph) (headPair[0]);
            final Enumeration<?> enm = subg.elements(GrappaConstants.NODE);
            while (enm.hasMoreElements()) {
                thisEdge =
                        new Edge(thisGraph, tail, tailPort, (Node) (enm
    ...
    public final java_cup.runtime.Symbol CUP$Parser$do_action(
            ...
            java.util.Stack<Symbol> CUP$Parser$stack, int CUP$Parser$top)
            throws java.lang.Exception {
            ...
            CUP$Parser$result =
                    new java_cup.runtime.Symbol(7/*optMacroName*/,
                            CUP$Parser$stack
                                .elementAt(CUP$Parser$top - 0).right,
                            CUP$Parser$stack
                                .elementAt(CUP$Parser$top - 0).right, null);
        }
            return CUP$Parser$result;
        ...
        case 4: // graph ::=
        {
            ...
            ((parser)).report_warning("The graph to parse is empty.",
                null);
