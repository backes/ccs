...
public interface GrappaConstants {
     ...
     */
    public final static java.awt.geom.AffineTransform IDENTXFRM =
    ...
    */
     ...
     */
    public final static String GRAPPA_BACKGROUND_COLOR_ATTR =
            GrappaConstants.PKG_LOWER + "BackgroundColor";
    /**
     * String name for selection color attribute (grappaSelectionColor).
     */
    public final static String GRAPPA_SELECTION_STYLE_ATTR =
            GrappaConstants.PKG_LOWER + "SelectionColor";
    /**
     * String name for deletion color attribute (grappaDeletionColor).
     */
    public final static String GRAPPA_DELETION_STYLE_ATTR =
            GrappaConstants.PKG_LOWER + "DeletionColor";
    /**
     * String name for fontsize adjustment attribute (grappaFontsizeAdjustment).
     */
    public final static String GRAPPA_FONTSIZE_ADJUSTMENT_ATTR =
            GrappaConstants.PKG_LOWER + "FontsizeAdjustment";
    /**
     ...
     */
    public final static int GRAPPA_BACKGROUND_COLOR_HASH =
            GRAPPA_BACKGROUND_COLOR_ATTR.hashCode();
    /**
     * Hash code for selection color attribute (grappaSelectionColor).
     */
    public final static int GRAPPA_SELECTION_STYLE_HASH =
            GRAPPA_SELECTION_STYLE_ATTR.hashCode();
    /**
     * Hash code for deletion color attribute (grappaDeletionColor).
     */
    public final static int GRAPPA_DELETION_STYLE_HASH =
            GRAPPA_DELETION_STYLE_ATTR.hashCode();
    /**
     * Hash code for fontsize adjustment attribute (grappaFontsizeAdjustment).
     */
    public final static int GRAPPA_FONTSIZE_ADJUSTMENT_HASH =
            GRAPPA_FONTSIZE_ADJUSTMENT_ATTR.hashCode();
    /**
