 ...
 * <OL>
 * <LI>"An Algorithm for Drawing General Undirected Graphs", Tomihisa Kamada
 * and Satoru Kawai, <I>Information Processing Letters</I>, Vol. 31 (1989), pp.
 * 7 - 15
 *
 * <LI>"Graph Drawing by Force-directed Placement", Thomas M. J. Fruchterman
 * and Edward M. Reingold, <I>Software - Practice and Experience</I>, Vol. 21
 * No. 11 (1991), pp. 1129 - 1164
 *
 ...
 * TARGET="_blank">http://www.bell-labs.com:80/user/gwills/NICHEguide/nichepaper.html</A>,
 * circa 1997
 * </OL>
 *
 * <P>
...
public abstract class Grappa implements att.grappa.GrappaConstants {
     ...
     */
    public static java.util.Hashtable<String, Integer> keyToShape =
            new java.util.Hashtable<String, Integer>();
    /**
     * Look-up table that maps a shape reference value to its name.
     */
    public static java.util.Hashtable<Integer, String> shapeToKey =
    ...
    static {
        ...
        final java.util.Enumeration<String> enm = keyToShape.keys();
        String key = null;
    ...
    /**
     * The java.awt.Toolkit.getDefaultToolkit() value, if available. It is not
     * populated until required, so if not graph display is requested, it will
     * remain null.
     */
    ...
    private static final ExceptionDisplay exceptionDisplay =
            new ExceptionDisplay(GrappaConstants.PKG_UPLOW
                    + ":  Exception Detected");
     ...
     * provided by the <TT>lp</TT> attribute is completely ignored. By
     * default, auto-positioning is used.
     */
     ...
     * automatically be set whenever the bounding box is calculated. By default,
     * the attribute is not set automatically.
     */
    ...
    /**
     * Indicates whether the <TT>rotation</TT> attribute is specifed in
     * degrees rather than radians. Degrees is the default.
     */
